...
/**
 * Because {@link PluginInfoLike} is an interface it cannot contain non public constants, so they are held here.
 */
final class PluginInfoLikeJsonConstants {
     ...
     * Stop creation
     */
    private PluginInfoLikeJsonConstants() {
